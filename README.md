...
| Features | object detection, tags, automatic caption, adult content detection, racy content detection, categories, faces, age, gender, foreground color, background color, dominant color, OCR, celebrity recognition, handwritten OCR, generate thumbnails, label detection | object detection, tags, adult content detection, spoof content detection, violent content detection, medical content detection, logo detection, landmark detection, OCR, face detection, dominant color, related image search, web entity search, sentiment detection, label detection | object detection, tags, label detection, categories, faces, age, gender, celebrity recognition, custom classifier | object detection, scene detection, faces, facial attributes, adult content detection, racy content detection, similar face search, celebrity recognition, OCR, label detection |  |
...
| Features | audio transcription, face tracking, face detection, face recognition, face labeling, speaker indexing, celebrity recognition, visual text recognition, voice activity detection, scene dectection, keyframe detection, sentiment analysis, translation, content moderation, keywords extraction, annotation, video segmentation | label detections, tags, shot detection, video segmentation |  | real-time analysis, face detection, face recognition, face tracking, face attributes, object detection, scene detection, activity detection, explicit content detection, celebrity recognition, obscured face tracking, similar face detection, emotion detection |  |
| **Face detection and verification in images** | **Face API** | **Cloud Vision API** |  | **Rekognition Image** | **TrueFace.ai** |
| Features | face detection, face identification, face comparison, face recognition, similar face search, face grouping, face attributes, baldness detection, hair color detection, smile detection, gender, age, facial hair, glasses, makeup, emotion detection, accessories, face landmarks, celebrity recognition, smile detection, sentiment detection | face detection, face attributes, smile detection, sentiment detection |  | object detection, scene detection, faces, emotion detection, facial attributes, adult content detection, racy content detection, similar face search, celebrity recognition, OCR, label detection | face detection, face recognition, spoof detection, face attributes, IFTTT integration, cloud or on-prem deployment |
...
| **Speech to text** | **Bing Speech API** | **Cloud Speech API** | **Speech to Text/Text-to-Speech** | **Lex/Polly/Transcribe** |  |
| Features | speech-to-text, text-to-speech | speech-to-text, text-to-speech, inappropriate content filtering | speech-to-text, speaker recognition, keyword extraction, acoustic alternatives, profanity filter, smart value formatting, expressiveness, voice transformations, custom voice model | speech-to-text, custom language models, multi-turn conversations, intent chaining, text-to-speech, custom acoustic model, custom vocabulary, SSML, text-to-speech |  |
